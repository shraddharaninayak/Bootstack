  ...
  return (
    <section className="py-24 bg-[#EEF6F7]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h2 className="mt-6 text-[48px] md:text-[48px] font-black leading-[0.92] tracking-[-0.04em] section-gradient-heading">
        ...
        <p className="mt-10 max-w-3xl text-[22px] leading-[1.7] text-[#235784]/70">
          ...
          and dynamic animations. No visual website builder constraints.
        </p>
